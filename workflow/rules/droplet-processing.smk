...
rule DropletProcessing_barcodeRanks:
    input:
...
rule DropletProcessing_barcodeRanksPlot:
    input:
        rds = "analysis/droplet-processing/barcodeRanks.rds"
    output:
...
rule DropletProcessing_emptyDrops:
    input:
        rds = "data/SingleCellExperiment.rds"
    output:
...
rule DropletProcessing_emptyDropsAmbient:
    input:
        rds = "data/SingleCellExperiment.rds"
    output:
...
rule DropletProcessing_emptyDropsLimited:
    input:
        rds = "analysis/droplet-processing/emptyDrops.rds"
    output:
...
rule DropletProcessing_emptyDropsLogProb:
    input:
        rds = "analysis/droplet-processing/emptyDrops.rds"
    output:
...
rule DropletProcessing_emptyDropsRank:
    input:
        rds = "analysis/droplet-processing/emptyDrops.rds"
    output:
...
rule DropletProcessing_emptyDropsPValue:
    input:
        rds = "analysis/droplet-processing/emptyDrops.ambient.rds"
    output:
...
rule DropletProcessing_filterByDrops:
    input:
